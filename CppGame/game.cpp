...
float player_1_score, player_2_score = 0;
...
internal void simulate_game(Input* input, float dt) {
	...
	draw_rect(0, 0, arena_half_size_x, arena_half_size_y, 0xE7E8D1);
	draw_arena_borders(arena_half_size_x, arena_half_size_y, 0xA7BEAE);
	...
	for (int i = 0; i < player_1_score; i++) {
		draw_rect(at_x, 47.f, 1.f, 1.f, 0xF96167);
		at_x += 2.5f;
	}
	at_x = 80;
	...
	draw_rect(ball_p_x, ball_p_y, ball_half_size, ball_half_size, 0x31473A);
	draw_rect(80, player_1_p, player_half_size_x, player_half_size_y, 0xB85042);
	draw_rect(-80, player_2_p, player_half_size_x, player_half_size_y, 0xB85042);
}
	else {
	...
	if (hot_button == 0) {
		...
		draw_text("SINGLEPLAYER", -10, -10, 1, 0xaaaaaa);
	}
	else {
		draw_text("MULTIPLAYER", -80, -10, 1, 0xaaaaaa);
		draw_text("SINGLE PLAYER", -10, -10, 1, 0xff0000);
	}
	draw_text("PONG KONG", -73, 40, 2, 0xffffff);
